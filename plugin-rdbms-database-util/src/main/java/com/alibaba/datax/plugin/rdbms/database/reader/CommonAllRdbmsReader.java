package com.alibaba.datax.plugin.rdbms.database.reader;
...
import com.alibaba.datax.plugin.rdbms.database.reader.util.OriginalConfPretreatmentUtil;
import com.alibaba.datax.plugin.rdbms.database.reader.util.PreCheckTask;
import com.alibaba.datax.plugin.rdbms.database.reader.util.ReaderSplitUtil;
import com.alibaba.datax.plugin.rdbms.database.reader.util.SingleTableSplitUtil;
...
public class CommonAllRdbmsReader {
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl.startsWith(com.alibaba.datax.plugin.rdbms.database.writer.Constant.OB10_SPLIT_STRING) && this.dataBaseType == DataBaseType.MySql) {
                String[] ss = this.jdbcUrl.split(com.alibaba.datax.plugin.rdbms.database.writer.Constant.OB10_SPLIT_STRING_PATTERN);
                if (ss.length != 3) {
